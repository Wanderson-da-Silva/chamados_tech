...
--
-- Dumping data for table `equipamentos_tipo`
--

LOCK TABLES `equipamentos_tipo` WRITE;
/*!40000 ALTER TABLE `equipamentos_tipo` DISABLE KEYS */;
/*!40000 ALTER TABLE `equipamentos_tipo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `maquina` (
  ...
  `is_unico` tinyint(1) NOT NULL DEFAULT 0,
  `status_operacional` enum('ativo','em_conserto','em_transito','descartado','perdido') NOT NULL DEFAULT 'ativo',
  PRIMARY KEY (`id`),
  ...
  KEY `idx_maquina_loja_status` (`loja_id`),
...
INSERT INTO `preventiva` VALUES (1,1,3,'Corretiva','2025-12-03','2026-02-23','concluida',NULL,NULL,NULL,0.00,NULL,NULL,'2025-12-02 01:10:22','2026-02-23 23:58:03'),(2,3,3,'Corretiva','2025-12-12','2026-02-23','concluida',NULL,NULL,NULL,0.00,NULL,NULL,'2025-12-02 01:11:16','2026-02-24 00:01:52'),(4,4,3,'Corretiva','2026-02-14','2026-02-24','concluida',NULL,NULL,NULL,0.00,NULL,NULL,'2025-12-02 01:16:21','2026-02-23 23:58:55'),(5,2,4,'corretiva','2026-01-23','2026-02-23','concluida',NULL,'ertet',NULL,0.00,NULL,NULL,'2026-01-29 21:17:45','2026-02-23 23:59:51'),(6,3,3,'limpeza','0000-00-00','2026-02-23','concluida',NULL,'teste program','234',0.00,45,NULL,'2026-02-05 00:44:59','2026-02-23 23:59:27'),(7,5,3,'calibragem','2026-02-20','2026-02-23','concluida',NULL,'fgh','fhff',0.00,5,NULL,'2026-02-05 00:45:35','2026-02-24 00:00:18'),(8,1,3,NULL,'0000-00-00',NULL,'cancelada',NULL,NULL,NULL,0.00,NULL,NULL,'2026-02-24 01:02:38','2026-02-24 01:57:33'),(9,1,4,NULL,'2026-03-04',NULL,'programada',NULL,'troca de oleo e filtros 34',NULL,0.00,30,NULL,'2026-02-24 23:52:11','2026-03-06 01:00:56');
...
BEGIN
    IF NEW.status = 'concluida' AND OLD.status != 'concluida' THEN
        ...
        -- Cria a próxima preventiva automaticamente
        INSERT INTO preventiva (maquina_id, data_programada, status)
        SELECT 
            NEW.maquina_id,
            DATE_ADD(NEW.data_realizada, INTERVAL periodicidade_preventiva DAY),
            'programada'
        FROM maquina
        WHERE id = NEW.maquina_id;
...
--
-- Table structure for table `preventiva_anexo`
--

DROP TABLE IF EXISTS `preventiva_anexo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `preventiva_anexo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `preventiva_id` int(11) NOT NULL,
  `nome_arquivo` varchar(255) NOT NULL,
  `nome_original` varchar(255) NOT NULL,
  `tipo_arquivo` varchar(10) NOT NULL,
  `tamanho_bytes` bigint(20) NOT NULL,
  ...
  KEY `idx_tipo_prev` (`tipo_anexo`),
  KEY `idx_data_upload_prev` (`data_upload`),
  CONSTRAINT `preventiva_anexo_ibfk_1` FOREIGN KEY (`preventiva_id`) REFERENCES `preventiva` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `preventiva_anexo`
--

LOCK TABLES `preventiva_anexo` WRITE;
/*!40000 ALTER TABLE `preventiva_anexo` DISABLE KEYS */;
/*!40000 ALTER TABLE `preventiva_anexo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `preventiva_historico`
--

DROP TABLE IF EXISTS `preventiva_historico`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `preventiva_historico` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `preventiva_id` int(11) NOT NULL,
  `usuario_id` int(11) NOT NULL,
  `status_anterior` varchar(20) DEFAULT NULL,
  ...
  KEY `usuario_id` (`usuario_id`),
  KEY `idx_preventiva` (`preventiva_id`),
  KEY `idx_data_prev` (`data_alteracao`),
  CONSTRAINT `preventiva_historico_ibfk_1` FOREIGN KEY (`preventiva_id`) REFERENCES `preventiva` (`id`) ON DELETE CASCADE,
  CONSTRAINT `preventiva_historico_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `preventiva_historico`
--

LOCK TABLES `preventiva_historico` WRITE;
/*!40000 ALTER TABLE `preventiva_historico` DISABLE KEYS */;
/*!40000 ALTER TABLE `preventiva_historico` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `transferencias` (
  ...
  `maquina_origem_id` int(11) NOT NULL,
  `maquina_destino_id` int(11) DEFAULT NULL,
  `usuario_id` int(11) NOT NULL,
  `tipo` enum('definitiva','temporaria','conserto','retorno_conserto','descarte','perda') NOT NULL,
  `status` enum('em_transito','aguardando_retorno','concluida','cancelada') NOT NULL DEFAULT 'em_transito',
  `quantidade_enviada` int(11) NOT NULL,
  `quantidade_retornada` int(11) DEFAULT NULL,
  `quantidade_perdida` int(11) DEFAULT NULL,
  `motivo` varchar(255) DEFAULT NULL,
  `observacoes` text DEFAULT NULL,
  `data_transferencia` datetime NOT NULL,
  `data_retorno_prevista` datetime DEFAULT NULL,
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_transferencia_saida
AFTER INSERT ON transferencias
FOR EACH ROW
BEGIN

    -- Só executa em transferências de saída (não em retornos)
    IF NEW.tipo IN ('definitiva', 'temporaria', 'conserto', 'descarte') THEN

        -- Debita quantidade na origem
        UPDATE maquinas
        SET quantidade = quantidade - NEW.quantidade_enviada
        WHERE id = NEW.maquina_origem_id;

        -- Atualiza status da máquina origem conforme tipo
        UPDATE maquinas
        SET status_operacional = CASE NEW.tipo
            WHEN 'conserto'  THEN 'em_conserto'
            WHEN 'descarte'  THEN 'descartado'
            WHEN 'definitiva' THEN 'em_transito'
            WHEN 'temporaria' THEN 'em_transito'
        END
        WHERE id = NEW.maquina_origem_id;

        -- Credita na máquina destino (exceto descarte)
        IF NEW.tipo != 'descarte' AND NEW.maquina_destino_id IS NOT NULL THEN
            UPDATE maquinas
            SET quantidade = quantidade + NEW.quantidade_enviada
            WHERE id = NEW.maquina_destino_id;
        END IF;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_transferencia_retorno
AFTER INSERT ON transferencias
FOR EACH ROW
BEGIN

    DECLARE v_perdida   INT DEFAULT 0;
    DECLARE v_retornada INT DEFAULT 0;

    IF NEW.tipo = 'retorno_conserto' AND NEW.transferencia_pai_id IS NOT NULL THEN

        SET v_perdida   = COALESCE(NEW.quantidade_perdida, 0);
        SET v_retornada = COALESCE(NEW.quantidade_retornada, 0);

        -- Debita da oficina tudo que foi enviado (retornado + perdido)
        UPDATE maquinas
        SET quantidade = quantidade - (v_retornada + v_perdida)
        WHERE id = NEW.maquina_origem_id;

        -- Credita na filial apenas o que retornou de fato
        IF v_retornada > 0 THEN
            UPDATE maquinas
            SET quantidade = quantidade + v_retornada,
                status_operacional = 'ativo'
            WHERE id = NEW.maquina_destino_id;
        END IF;

        -- Registra status perdido na oficina se houve perda
        IF v_perdida > 0 THEN
            UPDATE maquinas
            SET status_operacional = CASE
                WHEN v_retornada = 0 THEN 'perdido'  -- perda total
                ELSE 'ativo'                          -- perda parcial, ainda tem saldo
            END
            WHERE id = NEW.maquina_origem_id;
        END IF;

        -- Fecha a transferência pai
        UPDATE transferencias
        SET status = 'concluida',
            data_retorno_real = NOW()
        WHERE id = NEW.transferencia_pai_id;
...
INSERT INTO `usuario` VALUES (1,'admin','admin@techservice.com','$2y$10$exemplo_hash_senha','Administrador Sistema',NULL,'admin',1,NULL,'2025-12-02 00:55:54','2025-12-02 00:55:54'),(2,'trevo','trevo@trevo.com.br','$2y$10$3USn4Jh7vZHWd0GNSvrGFubZIIikF51Cavv7pyO4kvc/KtEjxdTAu','trevo','61994949494','admin',1,'2026-03-12 00:01:47','2025-12-02 01:05:20','2026-03-12 00:01:47'),(3,'vento','gunter@vento.com.br','$2y$10$bdIurFauNI5bRQsFUdKxC.kZmASuc39oECi8FFOsKHU7c/2SArv7.','gunter','996666555','tecnico',1,NULL,'2025-12-02 01:09:44','2025-12-02 01:09:44'),(4,'tecnico','tecnico@tecnico.com.br','$2y$10$fmRApB/bHToTuK27E.fknunerRfNvFjYF74rUx45n8.Eu6atI1wzi','tecnico','','tecnico',1,NULL,'2026-01-26 19:14:25','2026-01-26 19:14:25');
...
-- Dump completed on 2026-03-12 21:12:23
