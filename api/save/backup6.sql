...
BEGIN
    ...
    IF NEW.tipo IN ('definitiva', 'temporaria', 'conserto', 'descarte') THEN
        ...
        IF NEW.tipo != 'descarte' AND NEW.maquina_id IS NOT NULL THEN
            UPDATE maquina
            SET quantidade = quantidade + NEW.quantidade_enviada
            WHERE id = NEW.maquina_id;
        END IF;
...
INSERT INTO `usuario` VALUES (1,'admin','admin@techservice.com','$2y$10$exemplo_hash_senha','Administrador Sistema',NULL,'admin',1,NULL,'2025-12-02 00:55:54','2025-12-02 00:55:54'),(2,'trevo','trevo@trevo.com.br','$2y$10$3USn4Jh7vZHWd0GNSvrGFubZIIikF51Cavv7pyO4kvc/KtEjxdTAu','trevo','61994949494','admin',1,'2026-03-17 01:29:57','2025-12-02 01:05:20','2026-03-17 01:29:57'),(3,'vento','gunter@vento.com.br','$2y$10$bdIurFauNI5bRQsFUdKxC.kZmASuc39oECi8FFOsKHU7c/2SArv7.','gunter','996666555','tecnico',1,NULL,'2025-12-02 01:09:44','2025-12-02 01:09:44'),(4,'tecnico','tecnico@tecnico.com.br','$2y$10$fmRApB/bHToTuK27E.fknunerRfNvFjYF74rUx45n8.Eu6atI1wzi','tecnico','','tecnico',1,NULL,'2026-01-26 19:14:25','2026-01-26 19:14:25');
...
-- Dump completed on 2026-03-18 21:08:03
